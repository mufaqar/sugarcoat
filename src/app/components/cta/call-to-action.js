          ...
          <div className="border border-black p-4">
            <div className="mt-10 text-center">
              ...
              <div className="mt-9">
                ...
                <Link
                  href="mailto:hello@sugarcoatbeauty.com"
                  className="font-montserrat text-sm"
                >
              ...
              <div className="mt-9">
                ...
                <div className="mt-2 text-sm flex justify-center item gap-3">
                  <Link
                    href="https://www.facebook.com/SugarcoatBeauty/"
                    target="_blank"
                  >
                    <Image
                  ...
                  <Link
                    href="https://twitter.com/sugarcoatbeauty"
                    target="_blank"
                  >
                    <Image
                      src="/svg/twitter.svg"
                  ...
                  <Link
                    href="https://www.instagram.com/sugarcoatbeauty/"
                    target="_blank"
                  >
                    <Image
